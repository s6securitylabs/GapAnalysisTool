...
export const sourceMetadata: Record<LogSourceId, SourceMetadata> = {
  ...
  'hr-case': {
    glossaryTerms: ['least privilege', 'purpose limitation', 'legal hold', 'human review'],
    whyCollect: 'Provides governed workforce lifecycle, role, access-review, and approved case context needed to interpret technical activity during joiner, mover, leaver, contractor, or formal investigation windows.',
    positiveImpact: 'Improves access governance, offboarding assurance, multidisciplinary triage, and interpretation of activity against current duties without guessing motive.',
    negativeImpact: 'Highly sensitive and prone to confirmation bias; unrestricted notes, protected traits, health data, rumours, sentiment, or personal circumstances can create discrimination and false accusations.',
    privacyNotes: [
      'Use structured, minimum-necessary fields under a documented lawful purpose; do not ingest medical details, protected attributes, private communications, rumours, or unrestricted performance notes.',
      'Workforce context is a trigger for human review, never standalone proof or an automated employee risk score; require corroborating cyber, physical, approval, or business-process evidence.',
      'Apply role-based access, field-level auditing, retention limits, correction/appeal paths, and periodic privacy/legal review.',
    ],
    remediation: {
      gapOwner: 'HR systems',
      businessOwner: 'Insider threat program manager',
      engineeringOwner: 'HR systems',
      recommendation: 'Provide tightly governed lifecycle, role, access-review, and referral context using structured minimum-necessary fields with audited investigator access and multidisciplinary human review.',
      targetDate: '2026-08-26',
      slaDays: 30,
      status: 'planned',
      priority: 'critical',
      detectionUseCase: 'Governed workforce-transition and case context for corroborated investigation triage',
      validationMethod: 'Use synthetic workforce lifecycle, role-change, offboarding, referral, and access-review records to verify field minimisation, approvals, access auditing, retention, and correlation to synthetic technical events.',
      evidenceReference: '',
      acceptedRiskRationale: '',
      riskReviewDate: '',
      notes: 'Sensitive workforce context requires governance, human review, and independent corroboration.',
    },
  },
  'physical-access': {
